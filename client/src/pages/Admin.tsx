...
export default function Admin() {
    ...
    const handleInsertUser = async () => {
        if (!newUserName.trim() || !newUserTenantId.trim() || !newUserPassword.trim() || !newUserEmail.trim()) {
                            ...
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                                    <div>
                                        ...
                                        <CardDescription>Gerenciar criação usuários</CardDescription>
                                    </div>
